...
# First filter based on cell type
Part_DG_GC <- WT_Bap1KO[, WT_Bap1KO$cluster.annot %in% c("NSC_quiescent", "NSC_proliferative_2", "IP", "DG_GC")]
table(Part_DG_GC$cluster.annot) # to double check
...
# PLOT
pdf("output/condiments/UMAP_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option1.pdf", width=6, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = cluster.annot)) +
  geom_point(size = .7) +
  labs(col = "orig.ident") +
  theme_classic()
...
# Filter conditions based on your description:
# Keep cells with UMAP_1 > -3 and UMAP_2 < 2.5
selected_cells <- umap_coords[,1] < 5 &  umap_coords[,2] < 0 &  umap_coords[,2] > -11.75
...
pdf("output/condiments/UMAP_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option1_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col =  cluster.annot)) +
  geom_point(size = .7) +
  theme_classic()
dev.off()
...
## genotype overlap
pdf("output/condiments/UMAP_genotype_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option1_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = orig.ident)) +
  geom_point(size = .7) +
  scale_color_manual(values = c("blue", "red")) + # Specify colors here
  labs(col = "Genotype") +
...
pdf("output/condiments/UMAP_imbalance_score_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option1_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = scores)) +
  geom_point(size = .7) +
  scale_color_viridis_c(option = "C") +
  labs(col = "Scores") +
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_quiescent"), end.clus = c("DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_quiescent","NSC_proliferative_2"), end.clus = c("DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_quiescent"), end.clus = c("NSC_proliferative_2", "DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)
...
# First filter based on cell type
Part_DG_GC <- WT_Bap1KO[, WT_Bap1KO$cluster.annot %in% c("NSC_proliferative_1", "NSC_quiescent", "NSC_proliferative_2", "IP", "DG_GC")]
table(Part_DG_GC$cluster.annot) # to double check
...
# PLOT
pdf("output/condiments/UMAP_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option2.pdf", width=6, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = cluster.annot)) +
  geom_point(size = .7) +
  labs(col = "orig.ident") +
  theme_classic()
...
# Filter conditions based on your description:
# Keep cells with UMAP_1 > -3 and UMAP_2 < 2.5
selected_cells <- umap_coords[,1] < 5 &  umap_coords[,2] < 0 &  umap_coords[,2] > -15
...
pdf("output/condiments/UMAP_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option2_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col =  cluster.annot)) +
  geom_point(size = .7) +
  theme_classic()
dev.off()
...
## genotype overlap
pdf("output/condiments/UMAP_genotype_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option2_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = orig.ident)) +
  geom_point(size = .7) +
  scale_color_manual(values = c("blue", "red")) + # Specify colors here
  labs(col = "Genotype") +
...
pdf("output/condiments/UMAP_imbalance_score_WT_Bap1KO-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-Part_DG_GC_option2_subset.pdf", width=7, height=5)
ggplot(df, aes(x = umap_1, y = umap_2, col = scores)) +
  geom_point(size = .7) +
  scale_color_viridis_c(option = "C") +
  labs(col = "Scores") +
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_proliferative_1"), end.clus = c("DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_proliferative_1", "NSC_quiescent"), end.clus = c("DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_proliferative_1", "NSC_quiescent"), end.clus = c("NSC_proliferative_2", "DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)


Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_proliferative_1"), end.clus = c( "DG_GC") ,approx_points = 100, extend = 'y', stretch = 1)
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c("NSC_proliferative_1"), end.clus = c( "DG_GC") ,approx_points = 100, extend = 'n', stretch = 1)
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2"), end.clus = c( "DG_GC", "IP") ,approx_points = 100, extend = 'pc1', stretch = 1)



Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2"), end.clus = c( "DG_GC", "IP") ,approx_points = 100, extend = 'y', stretch = 1)


                 
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2"), end.clus = c( "DG_GC", "IP") ,approx_points = 100, extend = 'n', stretch = 1)


Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2", "NSC_proliferative_1"), end.clus = c( "DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1)

Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2", "NSC_proliferative_1"), end.clus = c( "DG_GC") ,approx_points = 100, extend = 'y', stretch = 1)

Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( "NSC_quiescent", "NSC_proliferative_2", "NSC_proliferative_1"), end.clus = c( "DG_GC") ,approx_points = 100, extend = 'n', stretch = 1)
...
Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( end.clus = c( "DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1) )

Part_DG_GC_subset <- slingshot(Part_DG_GC_subset, reducedDim = 'UMAP',
                 clusterLabels = colData(Part_DG_GC_subset)$cluster.annot,
                 start.clus = c( start.clus = c( "DG_GC") ,approx_points = 100, extend = 'pc1', stretch = 1) )
...
pdf("output/condiments/UMAP_trajectory_common_label_Part_DG_GC_option2_subset_WT-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-STARTNSCcquiesc_ENDDGGC_points100extendnstretch1distMethmnn_WTonly.pdf", width=14, height=5)
...
pdf("output/condiments/UMAP_trajectory_common_label_Part_DG_GC_option2_subset_WT-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-STARTNSCcquiesc_ENDDGGC_points100extendnstretch1distMethmnn_Bap1KOonly.pdf", width=14, height=5)
gridExtra::grid.arrange(grobs = plots, ncol = 2)
dev.off()
...
### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Pax6 gene : ONLY DG_GC trajectory (NSC prol2, IP, DG_GC)
...
Anlysis inspired from [this](https://github.com/quadbio/scMultiome_analysis_vignette/blob/main/Tutorial.md#section-3-gene-regulatory-network-reconstruction) adn [this](https://github.com/quadbio/Pando/issues/52)
...
pax6_regulon_genes <- positive_regulons_WT[["Pax6"]]


Part_DG_GC_subset_WT <- AddModuleScore(Part_DG_GC_subset_WT, features = list(pax6_regulon_genes), name = "Pax6_regulon")
Part_DG_GC_subset_Bap1KO <- AddModuleScore(Part_DG_GC_subset_Bap1KO, features = list(pax6_regulon_genes), name = "Pax6_regulon")
...
pdf("output/Pando/Pax6_regulon-WTvsBap1KO.pdf", width = 8, height = 6)
VlnPlot(
  combined,
  features = "Pax6_regulon1",
...
# Pax6 expression with regulon activity
p_expr <- VlnPlot(
  combined,
  features = "Pax6",
  group.by = "cluster.annot",
  ...
  ggtitle("Pax6 expression") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
# Pax6 regulon activity plot
p_regulon <- VlnPlot(
  combined,
  features = "Pax6_regulon1",
  group.by = "cluster.annot",
  ...
  ggtitle("Pax6 regulon activity") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

pdf("output/Pando/Pax6_expressionVSregulon-WTvsBap1KO.pdf", width = 8, height = 8)
p_expr / p_regulon
dev.off()



# Pax6 expression with regulon activity + STATS
df <- data.frame(
  cluster = combined$cluster.annot,
  condition = combined$condition,
  Pax6_expr = FetchData(combined, "Pax6"),
  Pax6_regulon = combined@meta.data$Pax6_regulon1
)
...
results <- lapply(clusters, function(cl) {
  ...
  # Expression test
  expr_test <- wilcox.test(Pax6 ~ condition, data = sub_df)
  
  # Regulon test
  reg_test <- wilcox.test(Pax6_regulon ~ condition, data = sub_df)
  
  tibble(
    cluster = cl,
    expr_pval = expr_test$p.value,
    regulon_pval = reg_test$p.value,
    expr_median_WT = median(sub_df$Pax6[sub_df$condition == "WT"]),
    expr_median_KO = median(sub_df$Pax6[sub_df$condition == "Bap1KO"]),
    regulon_median_WT = median(sub_df$Pax6_regulon[sub_df$condition == "WT"]),
    regulon_median_KO = median(sub_df$Pax6_regulon[sub_df$condition == "Bap1KO"])
  )
})
...
write.table(
  data.frame(gene = pax6_targets),
  file = "output/Pando/Pax6_positive_targets_WT.txt",
  quote = FALSE,
  row.names = FALSE,
  col.names = TRUE,
  sep = "\t"
)
#--> 28 target genes of Pax6 in WT; so many of them should be downregulated in Bap1KO
...
# GRN of WT only for the 28 target

# Extract only Pax6 GRN entries to genes in your positive regulon
pax6_edges <- coef_df %>%
  dplyr::filter(tf == "Pax6", target %in% pax6_regulon_genes, estimate > 0, padj < 0.05)
...
g <- igraph::graph_from_data_frame(
  d = pax6_edges %>% dplyr::select(from = tf, to = target),
  directed = TRUE
)

g_tidy <- as_tbl_graph(g)

pdf("output/Pando/GRN_pax6_regulon_genes_WT.pdf", width = 5, height = 5)
...
#### Investigate the list of Pax6 GRN

- Construct GRN in WT and check whether Pax6 targets are deregulated in Bap1KO
  - Check if they are deregulated during pseudotime (DG_GC trajectory)
  - Check if they are deregulated in NSC_prol 2
- Construct GRN separately for WT and Bap1KO
  - Check the target of Pax6 in each; and extract the genotype specific one
  - Check the 28 Pax6 target genes whether they are among the down reg genes in NSC-prol2
...
# Import the 28 Pax6 target genes
Part_DG_GC_WT_target <- read.table(
  "output/Pando/Pax6_positive_targets_WT.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
# Import Pax6 target genes

Part_DG_GC_subset_WT_GRN_allGenes <- read.table(
  "output/Pando/Part_DG_GC_subset_WT_GRN_allGenes.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
Part_DG_GC_subset_WT_GRN_allGenes_Pax6 = Part_DG_GC_subset_WT_GRN_allGenes %>%
  dplyr::filter(tf == "Pax6", padj < 0.05) # 35 target genes



Part_DG_GC_subset_Bap1KO_GRN_allGenes <- read.table(
  "output/Pando/Part_DG_GC_subset_Bap1KO_GRN_allGenes.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
Part_DG_GC_subset_Bap1KO_GRN_allGenes_Pax6 = Part_DG_GC_subset_Bap1KO_GRN_allGenes %>%
  dplyr::filter(tf == "Pax6", padj < 0.05) # 40 target genes


# Import pseudotime DEG DG_GC

gene_clusters <- read.table(
  "output/condiments/gene_clusters-traj1_DG_GC-dim40kparam42res065algo4feat2000correct1GeneActivityLinkPeaks-l2fc0-cl8.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
# Import NSC_prol2 DEG
cluster14 <- read.table(
  "output/Signac/cluster14-Bap1KO_response_multiome_QCV2vC1_dim40kparam42res065algo4feat2000_allGenes_correct.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
cluster14_DEGup = cluster14 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC > 0) # 95 genes
cluster14_DEGdown = cluster14 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC < 0) # 232 genes

# Import IP DEG
cluster13 <- read.table(
  "output/Signac/cluster13-Bap1KO_response_multiome_QCV2vC1_dim40kparam42res065algo4feat2000_allGenes_correct.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
cluster13_DEGup = cluster13 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC > 0) # 0 genes
cluster13_DEGdown = cluster13 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC < 0) # 3 genes
...
# Import DG_GC DEG
cluster6 <- read.table(
  "output/Signac/cluster6-Bap1KO_response_multiome_QCV2vC1_dim40kparam42res065algo4feat2000_allGenes_correct.txt",
  header = TRUE,
  sep = "\t",
  stringsAsFactors = FALSE
) %>%
...
cluster6_DEGup = cluster6 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC > 0) # 0 genes
cluster6_DEGdown = cluster6 %>%
  dplyr::filter(p_val_adj <0.05, avg_log2FC < 0) # 1,355 genes
...
## 28 Pax6 target wtih NSC prol2 DEG

### Extract gene sets
WT_target <- Part_DG_GC_WT_target$gene
deg_up_genes <- cluster14_DEGup$gene
deg_down_genes <- cluster14_DEGdown$gene

pdf("output/Pando/Part_DG_GC_WT_target-cluster14DEG.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    WT_target = WT_target,
    DEG_Up = deg_up_genes,
    DEG_Down = deg_down_genes
  ),
  filename = NULL,  # set to NULL to return the plot as a grob
  fill = c("skyblue", "tomato", "palegreen"),
  alpha = 0.5,
  cex = 1.5,
  cat.cex = 1.5,
  cat.pos = 0,
...
dev.off()
#### Get overlaps
overlap_WT_target_down <- intersect(WT_target, deg_down_genes)

cat("Overlap target & DEG Down:\n")
print(overlap_WT_target_down)




Part_DG_GC_WT_target


## Pax6 target wtih NSC prol2 DEG

### Extract gene sets
grn_genes <- Part_DG_GC_subset_WT_GRN_allGenes_Pax6$target
deg_up_genes <- cluster14_DEGup$gene
deg_down_genes <- cluster14_DEGdown$gene

pdf("output/Pando/Part_DG_GC_WT_Pax6_target-cluster14DEG.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    GRN = grn_genes,
    DEG_Up = deg_up_genes,
...
dev.off()
#### Get overlaps
overlap_grn_up <- intersect(grn_genes, deg_up_genes)
overlap_grn_down <- intersect(grn_genes, deg_down_genes)
overlap_up_down <- intersect(deg_up_genes, deg_down_genes)  # usually empty in proper DEGs
overlap_all_three <- Reduce(intersect, list(grn_genes, deg_up_genes, deg_down_genes))
cat("Overlap GRN & DEG Up:\n")
print(overlap_grn_up)
cat("\nOverlap GRN & DEG Down:\n")
print(overlap_grn_down)
cat("\nOverlap DEG Up & DEG Down (if any):\n")
print(overlap_up_down)
cat("\nOverlap among all three sets:\n")
print(overlap_all_three)
...
# Venn diagram
## Pax6 target wtih DG_GC DEG
### Extract gene sets
grn_genes <- Part_DG_GC_subset_WT_GRN_allGenes_Pax6$target
deg_down_genes <- cluster6_DEGdown$gene

pdf("output/Pando/Part_DG_GC_WT_Pax6_target-cluster6DEG.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    GRN = grn_genes,
    DEG_Down = deg_down_genes
...
# Venn diagram
## Pax6 target from WT vs Bap1KO
### Extract gene sets
grn_WT_genes <- Part_DG_GC_subset_WT_GRN_allGenes_Pax6$target
grn_Bap1KO_genes <- Part_DG_GC_subset_Bap1KO_GRN_allGenes_Pax6$target

pdf("output/Pando/Part_DG_GC_WT_Pax6_target-WTvsBap1KO.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    GRN_WT = grn_WT_genes,
    GRN_Bap1KO = grn_Bap1KO_genes
  ),
  filename = NULL,  # set to NULL to return the plot as a grob
  fill = c("skyblue", "tomato"),
  alpha = 0.5,
...
dev.off()
#### Get overlaps
overlap_grn <- intersect(grn_WT_genes, grn_Bap1KO_genes)

cat("\nOverlap GRN WT and Bap1KO:\n")
print(overlap_grn)
...
## Pax6 target wtih pseudotime DEGs
### Extract gene sets
grn_genes <- Part_DG_GC_subset_WT_GRN_allGenes_Pax6$target
gene_clusters_genes <- gene_clusters$gene


pdf("output/Pando/Part_DG_GC_WT_Pax6_target-gene_clusters_pseudotime.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    GRN = grn_genes,
    pseudotime_DEG = gene_clusters_genes
  ),
  filename = NULL,  # set to NULL to return the plot as a grob
  fill = c("skyblue", "tomato"),
  alpha = 0.5,
...
dev.off()
#### Get overlaps
overlap_grn_pseudotime <- intersect(grn_genes, gene_clusters_genes)
cat("Overlap GRN & DEG Pseudotime:\n")
print(overlap_grn_pseudotime)





## 28 true Pax6 target wtih pseudotime DEGs
### Extract gene sets
WT_target <- Part_DG_GC_WT_target$gene
gene_clusters_genes <- gene_clusters$gene


pdf("output/Pando/Part_DG_GC_WT_target-gene_clusters_pseudotime.pdf", width=5, height=5)
venn.plot <- venn.diagram(
  x = list(
    WT_target = WT_target,
    pseudotime_DEG = gene_clusters_genes
...
dev.off()
#### Get overlaps
overlap_grn_pseudotime <- intersect(WT_target, gene_clusters_genes)
cat("Overlap GRN & DEG Pseudotime:\n")
print(overlap_grn_pseudotime)
...
--> Very poor overlap of Pax6 target genes with DEG-pseudotime and DEG-cluter14 (NSC prol 2)




### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Lef1 gene : ONLY DG_GC trajectory (NSC prol2, IP, DG_GC)
...
# GRN plots
Part_DG_GC_subset_WT_GRN_allGenes_TF.Lef1 <- get_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF, tf='Lef1', graph='full_graph')
pdf("output/Pando/plot_tf_network-Lef1-Part_DG_GC_subset_WT_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF.Lef1, tf='Lef1', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Lef1-Part_DG_GC_subset_WT_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
plot_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF.Lef1, tf='Lef1', circular=TRUE, label_nodes = "tfs")
dev.off()
...
# FeaturePlot for Lef1 gene expression
p1 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = "Lef1",
  reduction = "umap",
...
# You don't need to switch assay for this since module scores are stored in meta.data
# But if you're using a fake assay for plotting, make sure these are accessible
# Lef1 regulon features
Lef1_pos <- "Lef1(+)"
Lef1_neg <- "Lef1(-)"
# Plot module scores using FeaturePlot with `cells = TRUE` (Seurat v5) or pulling from meta.data
p2 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = c(Lef1_pos, Lef1_neg),
  reduction = "umap",
  cols = c( "gray96", "darkgreen"),
  order = TRUE,
  ncol = 2
...
# Save to PDF
pdf("output/Pando/Lef1_regulon_WT.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
# GRN plots
Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Lef1 <- get_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF, tf='Lef1', graph='full_graph')
pdf("output/Pando/plot_tf_network-Lef1-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Lef1, tf='Lef1', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Lef1-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
plot_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Lef1, tf='Lef1', circular=TRUE, label_nodes = "tfs")
dev.off()
...
# Save to PDF
pdf("output/Pando/Lef1_regulon_Bap1KO.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
Lef1_regulon_genes <- positive_regulons_WT[["Lef1"]]




Part_DG_GC_subset_WT <- AddModuleScore(Part_DG_GC_subset_WT, features = list(Lef1_regulon_genes), name = "Lef1_regulon")
Part_DG_GC_subset_Bap1KO <- AddModuleScore(Part_DG_GC_subset_Bap1KO, features = list(Lef1_regulon_genes), name = "Lef1_regulon")
...
combined <- merge(Part_DG_GC_subset_WT, Part_DG_GC_subset_Bap1KO)
combined$condition <- factor(combined$condition, levels = c("WT", "Bap1KO"))
pdf("output/Pando/Lef1_regulon-WTvsBap1KO.pdf", width = 8, height = 6)
VlnPlot(
  combined,
...
# Lef1 expression with regulon activity
p_expr <- VlnPlot(
  combined,
  features = "Lef1",
  group.by = "cluster.annot",
  ...
  ggtitle("Lef1 expression") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
# Lef1 regulon activity plot
p_regulon <- VlnPlot(
  combined,
  features = "Lef1_regulon1",
  group.by = "cluster.annot",
  ...
  ggtitle("Lef1 regulon activity") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

pdf("output/Pando/Lef1_expressionVSregulon-WTvsBap1KO.pdf", width = 8, height = 8)
p_expr / p_regulon
dev.off()



# Lef1 expression with regulon activity + STATS
df <- data.frame(
  cluster = combined$cluster.annot,
  condition = combined$condition,
  Lef1_expr = FetchData(combined, "Lef1"),
  Lef1_regulon = combined@meta.data$Lef1_regulon1
)
...
results <- lapply(clusters, function(cl) {
  ...
  # Expression test
  expr_test <- wilcox.test(Lef1 ~ condition, data = sub_df)
  
  # Regulon test
  reg_test <- wilcox.test(Lef1_regulon ~ condition, data = sub_df)
  
  tibble(
    cluster = cl,
    expr_pval = expr_test$p.value,
    regulon_pval = reg_test$p.value,
    expr_median_WT = median(sub_df$Lef1[sub_df$condition == "WT"]),
    expr_median_KO = median(sub_df$Lef1[sub_df$condition == "Bap1KO"]),
    regulon_median_WT = median(sub_df$Lef1_regulon[sub_df$condition == "WT"]),
    regulon_median_KO = median(sub_df$Lef1_regulon[sub_df$condition == "Bap1KO"])
  )
})
...
# Collect the target of Lef1; many of these are significantly less express in Bap1KO
## Get all positive regulons
regulons_WT <- NetworkModules(Part_DG_GC_subset_WT_GRN_allGenes)
positive_regulons_WT <- regulons_WT@features[["genes_pos"]]
## Lef1 positive targets
Lef1_targets <- positive_regulons_WT[["Lef1"]]

write.table(
  data.frame(gene = Lef1_targets),
  file = "output/Pando/Lef1_positive_targets_WT.txt",
  quote = FALSE,
  row.names = FALSE,
  col.names = TRUE,
  sep = "\t"
)
#--> 60 target genes of Lef1 in WT; so many of them should be downregulated in Bap1KO



# check expressioon of all 60 target genes
# Make sure the object has condition info and RNA assay active
DefaultAssay(Part_DG_GC_subset) <- "RNA"
# UMAP plot of all Lef1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Lef1RegulonGenes_WTvsBap1KO.pdf", width = 7, height = 120)
FeaturePlot(
  Part_DG_GC_subset,
  features = Lef1_regulon_genes,
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkred"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# UMAP plot of all Lef1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Lef1RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 7, height = 120)
FeaturePlot(
  Part_DG_GC_subset,
  features = Lef1_regulon_genes, # Lef1_regulon_genes
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkgreen"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# Vln plot of all Lef1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/VlnPlot_Lef1RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 10, height = 40)
VlnPlot(
  Part_DG_GC_subset,
  features = Lef1_regulon_genes, # Lef1_regulon_genes
  group.by = "cluster.annot",
...
# GRN of WT only for the 60 target

# Extract only Lef1 GRN entries to genes in your positive regulon
Lef1_edges <- coef(Part_DG_GC_subset_WT_GRN_allGenes) %>%
  dplyr::filter(tf == "Lef1", target %in% Lef1_regulon_genes, estimate > 0, padj < 0.05)
...
# Build igraph object
g <- igraph::graph_from_data_frame(
  d = Lef1_edges %>% dplyr::select(from = tf, to = target),
  directed = TRUE
)

g_tidy <- as_tbl_graph(g)

pdf("output/Pando/GRN_Lef1_regulon_genes_WT.pdf", width = 5, height = 5)
ggraph(g_tidy, layout = "fr") +
  geom_edge_link(arrow = arrow(length = unit(3, 'mm')), end_cap = circle(2, 'mm'), edge_colour = "orange") +
  geom_node_point(size = 4, color = "steelblue") +
  geom_node_text(aes(label = name), repel = TRUE, size = 3) +
...
### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Gli gene : ONLY DG_GC trajectory (NSC prol2, IP, DG_GC)
...
# GRN plots
Part_DG_GC_subset_WT_GRN_allGenes_TF.Gli1 <- get_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF, tf='Gli1', graph='full_graph')
pdf("output/Pando/plot_tf_network-Gli1-Part_DG_GC_subset_WT_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF.Gli1, tf='Gli1', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Gli1-Part_DG_GC_subset_WT_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
...
# FeaturePlot for Gli1 gene expression
p1 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = "Gli1",
  reduction = "umap",
...
# You don't need to switch assay for this since module scores are stored in meta.data
# But if you're using a fake assay for plotting, make sure these are accessible
# Gli1 regulon features
Gli1_pos <- "Gli1(+)"
Gli1_neg <- "Gli1(-)"
# Plot module scores using FeaturePlot with `cells = TRUE` (Seurat v5) or pulling from meta.data
p2 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = c(Gli1_pos, Gli1_neg),
  reduction = "umap",
  cols = c( "gray96", "darkgreen"),
  order = TRUE,
  ncol = 2
...
# Save to PDF
pdf("output/Pando/Gli1_regulon_WT.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
pdf("output/Pando/plot_tf_network-Gli1-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Gli1, tf='Gli1', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Gli1-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
...
# Save to PDF
pdf("output/Pando/Gli1_regulon_Bap1KO.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
Gli1_regulon_genes <- positive_regulons_WT[["Gli1"]]




Part_DG_GC_subset_WT <- AddModuleScore(Part_DG_GC_subset_WT, features = list(Gli1_regulon_genes), name = "Gli1_regulon")
Part_DG_GC_subset_Bap1KO <- AddModuleScore(Part_DG_GC_subset_Bap1KO, features = list(Gli1_regulon_genes), name = "Gli1_regulon")
...
combined <- merge(Part_DG_GC_subset_WT, Part_DG_GC_subset_Bap1KO)
combined$condition <- factor(combined$condition, levels = c("WT", "Bap1KO"))
pdf("output/Pando/Gli1_regulon-WTvsBap1KO.pdf", width = 8, height = 6)
VlnPlot(
  combined,
  features = "Gli1_regulon1",
  group.by = "cluster.annot",      # X-axis: cell types
  split.by = "condition",          # Separate violins by condition
  pt.size = 0.1,
  cols = c("blue", "red")   # WT = black, Bap1KO = green (change as needed)
...
# Gli1 expression with regulon activity
p_expr <- VlnPlot(
  combined,
  features = "Gli1",
  group.by = "cluster.annot",
  ...
  ggtitle("Gli1 expression") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
# Gli1 regulon activity plot
p_regulon <- VlnPlot(
  combined,
  features = "Gli1_regulon1",
  group.by = "cluster.annot",
  ...
  ggtitle("Gli1 regulon activity") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

pdf("output/Pando/Gli1_expressionVSregulon-WTvsBap1KO.pdf", width = 8, height = 8)
p_expr / p_regulon
dev.off()



# Gli1 expression with regulon activity + STATS
df <- data.frame(
  cluster = combined$cluster.annot,
  condition = combined$condition,
  Gli1_expr = FetchData(combined, "Gli1"),
  Gli1_regulon = combined@meta.data$Gli1_regulon1
)
...
results <- lapply(clusters, function(cl) {
  ...
  # Expression test
  expr_test <- wilcox.test(Gli1 ~ condition, data = sub_df)
  
  # Regulon test
  reg_test <- wilcox.test(Gli1_regulon ~ condition, data = sub_df)
  
  tibble(
    cluster = cl,
    expr_pval = expr_test$p.value,
    regulon_pval = reg_test$p.value,
    expr_median_WT = median(sub_df$Gli1[sub_df$condition == "WT"]),
    expr_median_KO = median(sub_df$Gli1[sub_df$condition == "Bap1KO"]),
    regulon_median_WT = median(sub_df$Gli1_regulon[sub_df$condition == "WT"]),
    regulon_median_KO = median(sub_df$Gli1_regulon[sub_df$condition == "Bap1KO"])
  )
})
...
# Collect the target of Gli1; many of these are significantly less express in Bap1KO
## Get all positive regulons
regulons_WT <- NetworkModules(Part_DG_GC_subset_WT_GRN_allGenes)
positive_regulons_WT <- regulons_WT@features[["genes_pos"]]
## Gli1 positive targets
Gli1_targets <- positive_regulons_WT[["Gli1"]]

write.table(
  data.frame(gene = Gli1_targets),
  file = "output/Pando/Gli1_positive_targets_WT.txt",
  quote = FALSE,
  row.names = FALSE,
  col.names = TRUE,
  sep = "\t"
)
#--> 67 target genes of Gli1 in WT; so many of them should be downregulated in Bap1KO



# check expressioon of all 67 target genes
# Make sure the object has condition info and RNA assay active
DefaultAssay(Part_DG_GC_subset) <- "RNA"
# UMAP plot of all Gli1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Gli1RegulonGenes_WTvsBap1KO.pdf", width = 7, height = 130)
FeaturePlot(
  Part_DG_GC_subset,
  features = Gli1_regulon_genes,
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkred"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# UMAP plot of all Gli1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Gli1RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 7, height = 130)
FeaturePlot(
  Part_DG_GC_subset,
  features = Gli1_regulon_genes, # Gli1_regulon_genes
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkgreen"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# Vln plot of all Gli1 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/VlnPlot_Gli1RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 10, height = 40)
VlnPlot(
  Part_DG_GC_subset,
  features = Gli1_regulon_genes, # Gli1_regulon_genes
  group.by = "cluster.annot",
...
# GRN of WT only for the 67 target

# Extract only Gli1 GRN entries to genes in your positive regulon
Gli1_edges <- coef(Part_DG_GC_subset_WT_GRN_allGenes) %>%
  dplyr::filter(tf == "Gli1", target %in% Gli1_regulon_genes, estimate > 0, padj < 0.05)
...
# Build igraph object
g <- igraph::graph_from_data_frame(
  d = Gli1_edges %>% dplyr::select(from = tf, to = target),
  directed = TRUE
)

g_tidy <- as_tbl_graph(g)

pdf("output/Pando/GRN_Gli1_regulon_genes_WT.pdf", width = 5, height = 5)
ggraph(g_tidy, layout = "fr") +
  geom_edge_link(arrow = arrow(length = unit(3, 'mm')), end_cap = circle(2, 'mm'), edge_colour = "orange") +
  geom_node_point(size = 4, color = "steelblue") +
  geom_node_text(aes(label = name), repel = TRUE, size = 3) +
...
--> Genes `Smo, Axin1, Ctnnb1` not found in `coef(Part_DG_GC_subset_Bap1KO_GRN_allGenes)`..


### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Find TFs that target Pax6 (Klf12) : ONLY DG_GC trajectory (NSC prol2, IP, DG_GC)
...
Part_DG_GC_subset_WT_GRN_allGenes_TF.Klf12 <- get_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF, tf='Klf12', graph='full_graph')


# GRN plots
Part_DG_GC_subset_WT_GRN_allGenes_TF.Klf12 <- get_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF, tf='Klf12', graph='full_graph')
pdf("output/Pando/plot_tf_network-Klf12-Part_DG_GC_subset_WT_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF.Klf12, tf='Klf12', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Klf12-Part_DG_GC_subset_WT_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
plot_tf_network(Part_DG_GC_subset_WT_GRN_allGenes_TF.Klf12, tf='Klf12', circular=TRUE, label_nodes = "tfs")
dev.off()
...
# FeaturePlot for Klf12 gene expression
p1 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = "Klf12",
  reduction = "umap",
...
# You don't need to switch assay for this since module scores are stored in meta.data
# But if you're using a fake assay for plotting, make sure these are accessible
# Klf12 regulon features
Klf12_pos <- "Klf12(+)"
Klf12_neg <- "Klf12(-)"
# Plot module scores using FeaturePlot with `cells = TRUE` (Seurat v5) or pulling from meta.data
p2 <- FeaturePlot(
  Part_DG_GC_subset_WT,
  features = c(Klf12_pos, Klf12_neg),
  reduction = "umap",
  cols = c( "gray96", "darkgreen"),
  order = TRUE,
  ncol = 2
...
# Save to PDF
pdf("output/Pando/Klf12_regulon_WT.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
# GRN plots
Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Klf12 <- get_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF, tf='Klf12', graph='full_graph')
pdf("output/Pando/plot_tf_network-Klf12-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks.pdf", width=5, height=2)
plot_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Klf12, tf='Klf12', circular=F, label_nodes = "all")
dev.off()
pdf("output/Pando/plot_tf_network-Klf12-Part_DG_GC_subset_Bap1KO_RegionsLinkPeaks-circular_tfs.pdf", width=25, height=10)
plot_tf_network(Part_DG_GC_subset_Bap1KO_GRN_allGenes_TF.Klf12, tf='Klf12', circular=TRUE, label_nodes = "tfs")
dev.off()
...
# Save to PDF
pdf("output/Pando/Klf12_regulon_Bap1KO.pdf", width = 10, height = 6)
(p1 / p2) + patchwork::plot_layout(heights = c(1, 1))
dev.off()
...
Klf12_regulon_genes <- positive_regulons_WT[["Klf12"]]




Part_DG_GC_subset_WT <- AddModuleScore(Part_DG_GC_subset_WT, features = list(Klf12_regulon_genes), name = "Klf12_regulon")
Part_DG_GC_subset_Bap1KO <- AddModuleScore(Part_DG_GC_subset_Bap1KO, features = list(Klf12_regulon_genes), name = "Klf12_regulon")
...
combined <- merge(Part_DG_GC_subset_WT, Part_DG_GC_subset_Bap1KO)
combined$condition <- factor(combined$condition, levels = c("WT", "Bap1KO"))
pdf("output/Pando/Klf12_regulon-WTvsBap1KO.pdf", width = 8, height = 6)
VlnPlot(
  combined,
  features = "Klf12_regulon1",
  group.by = "cluster.annot",      # X-axis: cell types
  split.by = "condition",          # Separate violins by condition
  pt.size = 0.1,
  cols = c("blue", "red")   # WT = black, Bap1KO = green (change as needed)
...
# Klf12 expression with regulon activity
p_expr <- VlnPlot(
  combined,
  features = "Klf12",
  group.by = "cluster.annot",
  ...
  ggtitle("Klf12 expression") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
# Klf12 regulon activity plot
p_regulon <- VlnPlot(
  combined,
  features = "Klf12_regulon1",
  group.by = "cluster.annot",
  ...
  ggtitle("Klf12 regulon activity") +
  NoLegend() + 
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

pdf("output/Pando/Klf12_expressionVSregulon-WTvsBap1KO.pdf", width = 8, height = 8)
p_expr / p_regulon
dev.off()



# Klf12 expression with regulon activity + STATS
df <- data.frame(
  cluster = combined$cluster.annot,
  condition = combined$condition,
  Klf12_expr = FetchData(combined, "Klf12"),
  Klf12_regulon = combined@meta.data$Klf12_regulon1
)
...
results <- lapply(clusters, function(cl) {
  ...
  # Expression test
  expr_test <- wilcox.test(Klf12 ~ condition, data = sub_df)
  
  # Regulon test
  reg_test <- wilcox.test(Klf12_regulon ~ condition, data = sub_df)
  
  tibble(
    cluster = cl,
    expr_pval = expr_test$p.value,
    regulon_pval = reg_test$p.value,
    expr_median_WT = median(sub_df$Klf12[sub_df$condition == "WT"]),
    expr_median_KO = median(sub_df$Klf12[sub_df$condition == "Bap1KO"]),
    regulon_median_WT = median(sub_df$Klf12_regulon[sub_df$condition == "WT"]),
    regulon_median_KO = median(sub_df$Klf12_regulon[sub_df$condition == "Bap1KO"])
  )
})
...
# Collect the target of Klf12; many of these are significantly less express in Bap1KO
## Get all positive regulons
regulons_WT <- NetworkModules(Part_DG_GC_subset_WT_GRN_allGenes)
positive_regulons_WT <- regulons_WT@features[["genes_pos"]]
## Klf12 positive targets
Klf12_targets <- positive_regulons_WT[["Klf12"]]

write.table(
  data.frame(gene = Klf12_targets),
  file = "output/Pando/Klf12_positive_targets_WT.txt",
  quote = FALSE,
  row.names = FALSE,
  col.names = TRUE,
  sep = "\t"
)
#--> 52 target genes of Klf12 in WT; so many of them should be downregulated in Bap1KO



# check expressioon of all 52 target genes
# Make sure the object has condition info and RNA assay active
DefaultAssay(Part_DG_GC_subset) <- "RNA"
# UMAP plot of all Klf12 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Klf12RegulonGenes_WTvsBap1KO.pdf", width = 7, height = 120)
FeaturePlot(
  Part_DG_GC_subset,
  features = Klf12_regulon_genes,
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkred"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# UMAP plot of all Klf12 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/FeaturePlot_Klf12RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 7, height = 120)
FeaturePlot(
  Part_DG_GC_subset,
  features = Klf12_regulon_genes, # Klf12_regulon_genes
  reduction = "umap",
  split.by = "orig.ident",
  cols = c("lightgrey", "darkgreen"),  # adjust color if needed
  ncol = 5,
...
DefaultAssay(Part_DG_GC_subset) <- "GeneActivity"
# Vln plot of all Klf12 regulon genes, split by WT vs Bap1KO
pdf("output/Pando/VlnPlot_Klf12RegulonGenes_WTvsBap1KO-GeneActivity.pdf", width = 10, height = 40)
VlnPlot(
  Part_DG_GC_subset,
  features = Klf12_regulon_genes, # Klf12_regulon_genes
  group.by = "cluster.annot",
...
# GRN of WT only for the 52 target

# Extract only Klf12 GRN entries to genes in your positive regulon
Klf12_edges <- coef(Part_DG_GC_subset_WT_GRN_allGenes) %>%
  dplyr::filter(tf == "Klf12", target %in% Klf12_regulon_genes, estimate > 0, padj < 0.05)
...
# Build igraph object
g <- igraph::graph_from_data_frame(
  d = Klf12_edges %>% dplyr::select(from = tf, to = target),
  directed = TRUE
)

g_tidy <- as_tbl_graph(g)

pdf("output/Pando/GRN_Klf12_regulon_genes_WT.pdf", width = 5, height = 5)
ggraph(g_tidy, layout = "fr") +
  geom_edge_link(arrow = arrow(length = unit(3, 'mm')), end_cap = circle(2, 'mm'), edge_colour = "orange") +
  geom_node_point(size = 4, color = "steelblue") +
  geom_node_text(aes(label = name), repel = TRUE, size = 3) +
  theme_void() +
  ggtitle("Klf12 GRN (WT)")
dev.off()
```
...
### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Find TFs that target Pax6 (Gli2) : ONLY DG_GC trajectory (NSC prol2, IP, DG_GC)
...
### WT and Bap1KO separated with regions LinkPeaks() - gene peak correlated - Pax6 : ALL NSC _ DG_GC trajectory
...
--> in `infer_grn()` peak_to_gene_method as GREAT gave very few TFs so lets keep it as `peak_to_gene_method = 'Signac'`
  --> Lets only change `method = glm` to something else: glmnet (also to be tested if needed: `cv.glmnet, xgb`) : 
    - **`glmnet` gave the exact same as glm but without the pval information...**


--> **Share default method to Casey (Signac, glm)**: seems to perform the best



### Alternative method (Signac, glmnet) – NSC_prol2, IP, DG_GC
...
### Alternative method (Default: Signac, glmnet) – All NSC (NSC_prol1, NSC_prol2, NSC_quiesc), IP, DG_GC
...
# TESTING THE MODEL TO HAVE OUR TF of interest in the GRN ##################
Part_DG_GC_allNSC_subset_WT_GRN_glmnet_allGenes <- infer_grn(
    Part_DG_GC_allNSC_subset_WT_GRN,
    peak_to_gene_method = 'Signac', # or use 'GREAT' consider overlapping regulatory regions, lets keep Signac
    method = 'glmnet', # other model can be tested: ('glmnet', 'cv.glmnet', 'xgb')
    genes = genes_filtered,
...
Let's re-run Pando entirely to make sure everything is clean, notably the pvalue and treshold used. Then send output raw files to Casey for investigation.





### Default (Signac, glm) - NSC_prol2, IP, DG_GC

--> File saved as clean `*-pthresh05nvar2min1rsq05*` = parameters from `find_modules()`
...
#saveRDS(Part_DG_GC_subset_WT_GRN, file = "output/Pando/Part_DG_GC_subset_WT_GRN_motif.rds")
#load: Part_DG_GC_subset_WT_GRN <- readRDS(file = "output/Pando/Part_DG_GC_subset_WT_GRN_motif.rds")
pdf("output/Pando/UMAP-Part_DG_GC_subset_WT_GRN.pdf", width=7, height=6)
DimPlot(Part_DG_GC_subset_WT, reduction = "umap", label = TRUE, pt.size = 0.5)
dev.off()
#############################################
...
# Write the data frame to a .txt file
write.table(coef(Part_DG_GC_subset_WT_GRN_allGenes), 
            file = "output/Pando/Part_DG_GC_subset_WT_GRN_allGenes-pthresh05nvar2min1rsq05.txt", 
            sep = "\t", 
            quote = FALSE, 
            row.names = FALSE, 
            col.names = TRUE)
...
#saveRDS(Part_DG_GC_subset_Bap1KO_GRN, file = "output/Pando/Part_DG_GC_subset_Bap1KO_GRN_motif.rds")
#load: Part_DG_GC_subset_Bap1KO_GRN <- readRDS(file = "output/Pando/Part_DG_GC_subset_Bap1KO_GRN_motif.rds")
pdf("output/Pando/UMAP-Part_DG_GC_subset_Bap1KO_GRN.pdf", width=7, height=6)
DimPlot(Part_DG_GC_subset_Bap1KO, reduction = "umap", label = TRUE, pt.size = 0.5)
dev.off()
#############################################
...
# Write the data frame to a .txt file
write.table(coef(Part_DG_GC_subset_Bap1KO_GRN_allGenes), 
            file = "output/Pando/Part_DG_GC_subset_Bap1KO_GRN_allGenes-pthresh05nvar2min1rsq05.txt", 
            sep = "\t", 
            quote = FALSE, 
            row.names = FALSE, 
            col.names = TRUE)
...
### Default (Signac, glm) - all NSC (NSC_prol1, NSC_prol2, NSC_quiesc), IP, DG_GC
...
#saveRDS(Part_DG_GC_allNSC_subset_WT_GRN, file = "output/Pando/Part_DG_GC_allNSC_subset_WT_GRN_motif.rds")
#load: Part_DG_GC_allNSC_subset_WT_GRN <- readRDS(file = "output/Pando/Part_DG_GC_allNSC_subset_WT_GRN_motif.rds")
pdf("output/Pando/UMAP-Part_DG_GC_allNSC_subset_WT_GRN.pdf", width=7, height=6)
DimPlot(Part_DG_GC_allNSC_subset_WT, reduction = "umap", label = TRUE, pt.size = 0.5)
dev.off()
#############################################
...
# Write the data frame to a .txt file
write.table(coef(Part_DG_GC_allNSC_subset_WT_GRN_allGenes), 
            file = "output/Pando/Part_DG_GC_allNSC_subset_WT_GRN_allGenes-pthresh05nvar2min1rsq05.txt", 
            sep = "\t", 
            quote = FALSE, 
            row.names = FALSE, 
            col.names = TRUE)
...
#saveRDS(Part_DG_GC_allNSC_subset_Bap1KO_GRN, file = "output/Pando/Part_DG_GC_allNSC_subset_Bap1KO_GRN_motif.rds")
#load: Part_DG_GC_allNSC_subset_Bap1KO_GRN <- readRDS(file = "output/Pando/Part_DG_GC_allNSC_subset_Bap1KO_GRN_motif.rds")
pdf("output/Pando/UMAP-Part_DG_GC_allNSC_subset_Bap1KO_GRN.pdf", width=7, height=6)
DimPlot(Part_DG_GC_allNSC_subset_Bap1KO, reduction = "umap", label = TRUE, pt.size = 0.5)
dev.off()
#############################################
...
# Write the data frame to a .txt file
write.table(coef(Part_DG_GC_allNSC_subset_Bap1KO_GRN_allGenes), 
            file = "output/Pando/Part_DG_GC_allNSC_subset_Bap1KO_GRN_allGenes-pthresh05nvar2min1rsq05.txt", 
            sep = "\t", 
            quote = FALSE, 
            row.names = FALSE, 
            col.names = TRUE)
