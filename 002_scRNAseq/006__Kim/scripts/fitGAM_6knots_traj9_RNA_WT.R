...
#### Extract the pseudotimes and cell weights for the NINETH lineage
pseudotimes <- slingPseudotime(RNA_WT, na = FALSE) [,9] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(RNA_WT) [,9]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
saveRDS(traj9_RNA_WT, file = "output/condiments/traj9_RNA_WT.rds")
