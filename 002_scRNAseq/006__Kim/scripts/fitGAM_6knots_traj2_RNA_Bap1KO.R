...
pseudotimes <- slingPseudotime(RNA_Bap1KO, na = FALSE) [,2] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(RNA_Bap1KO) [,2]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
saveRDS(traj2_RNA_Bap1KO, file = "output/condiments/traj2_RNA_Bap1KO.rds")
