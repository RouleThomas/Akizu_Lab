...
pseudotimes <- slingPseudotime(Part_SubC1, na = FALSE) [,3]
cellweights <- slingCurveWeights(Part_SubC1) [,3]
...
saveRDS(traj_Part_SubC1, file = "output/condiments/traj_Part_SubC1.rds")
