...
sbatch scripts/cellranger_count_WT_p35_CB_Rep2.sh # 20178354 fail fastq path; 20203367 fail sample name 20250639 xxx 
...
sbatch scripts/cellranger_count_WT_p180_CB_Rep2.sh # 20178497 fail fastq path; 20203464 fail sample name 20251147 xxx 
...
sbatch scripts/cellranger_count_Kcnc1_p180_CB_Rep2.sh # 20178466 fail fastq path; 20203419 fail sample name 20250949 xxx 
...
sbatch scripts/scrublet_WT_p14.sh # 20255539 xxx
sbatch scripts/scrublet_Kcnc1_p14.sh # 20255755 xxx
sbatch --dependency=afterany:20250639 scripts/scrublet_WT_p35.sh # 20255864 xxx
sbatch scripts/scrublet_Kcnc1_p35.sh # 20255900 xxx
sbatch --dependency=afterany:20251147 scripts/scrublet_WT_p180.sh # 20255934 xxx
sbatch --dependency=afterany:20250949 scripts/scrublet_Kcnc1_p180.sh # 20255974 xxx
...
```
Doublet detection score (YAP1scRNAseq ranged between 0.1 to 42%): now range from xxx to xxx%
