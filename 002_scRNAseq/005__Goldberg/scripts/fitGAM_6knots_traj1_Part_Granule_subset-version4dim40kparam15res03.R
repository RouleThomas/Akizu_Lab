...
pseudotimes <- slingPseudotime(Part_Granule_subset, na = FALSE) [,1]
cellweights <- slingCurveWeights(Part_Granule_subset) [,1]
...
saveRDS(traj1, file = "output/condiments/traj1_Part_Granule_subset-version4dim40kparam15res03.rds")
