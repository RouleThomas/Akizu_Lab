...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CB_version4dim30kparam10res02_allGenes_default.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CB_version4dim30kparam10res02_allGenes_default.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p35_CB_version4dim30kparam10res02_allGenes_default.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CB_version4dim30kparam10res02_allGenes_default.txt")
