...
pseudotimes <- slingPseudotime(Part_MLI1_subset, na = FALSE) [,2]
cellweights <- slingCurveWeights(Part_MLI1_subset) [,2]
...
saveRDS(traj2, file = "output/condiments/traj2_Part_MLI1_subset-version5dim50kparam30res25.rds")
