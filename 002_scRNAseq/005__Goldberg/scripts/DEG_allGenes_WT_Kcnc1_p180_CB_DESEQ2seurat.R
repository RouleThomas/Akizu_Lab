...
## ROUND THE RAW COUNTS, needed for DESEQ2
WT_Kcnc1_p180_CB_1step.sct@assays$RNA@counts <- round(WT_Kcnc1_p180_CB_1step.sct@assays$RNA@counts)
WT_Kcnc1_p180_CB_1step.sct[["RNA"]]@counts <- as.matrix(WT_Kcnc1_p180_CB_1step.sct[["RNA"]]@counts)+1 # Add+1 to avoid the zero error
...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res02_allGenes_DESEQ2seurat.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res02_allGenes_DESEQ2seurat.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p180_CB_QCV4dim50kparam20res02_allGenes_DESEQ2seurat.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res02_allGenes_DESEQ2seurat.txt")
