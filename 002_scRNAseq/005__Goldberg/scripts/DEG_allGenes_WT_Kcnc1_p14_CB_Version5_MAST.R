...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p14_CB_version5dim40kparam15res015_allGenes_MAST.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p14_CB_version5dim40kparam15res015_allGenes_MAST.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p14_CB_version5dim40kparam15res015_allGenes_MAST.pdf")
