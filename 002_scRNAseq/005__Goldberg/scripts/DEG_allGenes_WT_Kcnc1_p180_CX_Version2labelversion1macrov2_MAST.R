...
WT_Kcnc1_p180_CX_1step.sct$celltype.stim <- paste(WT_Kcnc1_p180_CX_1step.sct$macro, WT_Kcnc1_p180_CX_1step.sct$condition,
    sep = "-")
...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CX_version2dim30kparam30res04macrov2_allGenes_MAST.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CX_version2dim30kparam30res04macrov2_allGenes_MAST.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p180_CX_version2dim30kparam30res04macrov2_allGenes_MAST.pdf")
