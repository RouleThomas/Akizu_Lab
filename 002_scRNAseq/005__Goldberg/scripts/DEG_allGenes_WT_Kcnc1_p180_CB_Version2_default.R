...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_version2dim30kparam10res01_allGenes_default.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_version2dim30kparam10res01_allGenes_default.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p180_CB_version2dim30kparam10res01_allGenes_default.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_version2dim30kparam10res01_allGenes_default.txt")
