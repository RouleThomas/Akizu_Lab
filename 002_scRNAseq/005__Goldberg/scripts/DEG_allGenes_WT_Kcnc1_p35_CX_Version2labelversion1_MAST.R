...
WT_Kcnc1_p35_CX_1step.sct$celltype.stim <- paste(WT_Kcnc1_p35_CX_1step.sct$cluster.annot, WT_Kcnc1_p35_CX_1step.sct$condition,
    sep = "-")
...
for (cluster in clusters) {
  ...
  markers <- FindMarkers(WT_Kcnc1_p35_CX_1step.sct, 
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CX_version2dim35kparam15res065_allGenes_MAST.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CX_version2dim35kparam15res065_allGenes_MAST.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p35_CX_version2dim35kparam15res065_allGenes_MAST.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p35_CX_version2dim30kparam50res07_allGenes_MAST.txt")
