...
WT_Kcnc1_p14_CB_1step.sct <- readRDS(file = "output/seurat/WT_Kcnc1_p14_CB_1step.sct_V5_numeric_GranuleCluster1.rds") # reduce resolution for cluster granule DEG QCV3dim30kparam50res02
set.seed(42)
...
WT_Kcnc1_p14_CB_1step.sct$celltype.stim <- paste(WT_Kcnc1_p14_CB_1step.sct$seurat_clusters, WT_Kcnc1_p14_CB_1step.sct$condition,
    sep = "-")
...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p14_CB_QCV3dim30kparam50res02_allGenes_MAST_GranuleCluster.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p14_CB_QCV3dim30kparam50res02_allGenes_MAST_GranuleCluster.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p14_CB_QCV3dim30kparam50res02_allGenes_MAST_GranuleCluster.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p14_CB_QCV3dim30kparam50res02_allGenes_MAST_GranuleCluster.txt")
