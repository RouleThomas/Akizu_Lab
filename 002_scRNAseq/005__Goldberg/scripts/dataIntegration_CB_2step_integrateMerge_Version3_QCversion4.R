...
# SAVE OUTPUT
saveRDS(WT_Kcnc1_CB_integrateMerge.sct, file = "output/seurat/WT_Kcnc1_CB_integrateMerge_Version3_QCversion4.sct.rds")
...
pdf("output/seurat/UMAP_WT_Kcnc1_CB_Version3_QCversion4-dim50kparam20res02.pdf", width=7, height=6)
...
pdf("output/seurat/UMAP_WT_Kcnc1_CB-2stepIntegrateMerge_Version3_QCversion4.pdf", width=7, height=6)
DimPlot(WT_Kcnc1_CB_integrateMerge.sct, reduction = "umap", label=TRUE)
dev.off()
