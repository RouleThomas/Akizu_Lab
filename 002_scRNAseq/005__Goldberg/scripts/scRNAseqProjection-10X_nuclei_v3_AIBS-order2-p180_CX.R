...
WT_Kcnc1_p180_CX_1step <- readRDS(file = "output/seurat/WT_Kcnc1_p180_CX_1step-version2dim30kparam30res04.sct_V1_numeric.rds") # 
DefaultAssay(WT_Kcnc1_p180_CX_1step) <- "RNA"
...
shared_features <- intersect(
  rownames(Yao_Cortex),
  rownames(WT_Kcnc1_p180_CX_1step)
)
...
WT_Kcnc1_p180_CX_1step <- AddMetaData(WT_Kcnc1_p180_CX_1step, metadata = predictions)


# Step 3: Project query onto reference UMAP
WT_Kcnc1_p180_CX_1step <- MapQuery(
  anchorset = anchors,
  reference = Yao_Cortex,
  query = WT_Kcnc1_p180_CX_1step,
...
saveRDS(WT_Kcnc1_p180_CX_1step, file = "output/seurat/WT_Kcnc1_p180_CX_1step-10X_nuclei_v3_AIBS-30dim-order2-p35_CX.rds") 
