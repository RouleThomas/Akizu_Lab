...
curves <- bind_rows(lapply(sdss, slingCurves, as.df = TRUE),
                    .id = "condition")
pdf("output/condiments/UMAP_trajectory_WT_Kcnc1_CB-version2dim50kparam30res02-START-MLI2_3-END-MLI2_2-points100extendnstretch1.pdf", width=6, height=5)
...
# Save RData
save.image(file = "output/condiments/pseudotime_allCells_v1_MLI2-version2.RData")
