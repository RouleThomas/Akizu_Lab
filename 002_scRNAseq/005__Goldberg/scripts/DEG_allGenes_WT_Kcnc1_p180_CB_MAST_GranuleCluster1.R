...
WT_Kcnc1_p180_CB_1step.sct$celltype.stim <- paste(WT_Kcnc1_p180_CB_1step.sct$seurat_clusters, WT_Kcnc1_p180_CB_1step.sct$condition,
    sep = "-")
...
for (cluster in clusters) {
  ...
  output_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res005_allGenes_MAST_GranuleCluster.txt")
...
for (cluster in clusters) {
  ...
  input_filename <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res005_allGenes_MAST_GranuleCluster.txt")
  ...
  if (file.exists(input_filename)) {
    ...
    pdf_filename <- paste0("output/seurat/VolcanoPlot_", cluster, "_p180_CB_QCV4dim50kparam20res005_allGenes_MAST_GranuleCluster.pdf")
...
for (cluster in clusters) {
  file_path <- paste0("output/seurat/", cluster, "-Kcnc1_response_p180_CB_QCV4dim50kparam20res005_allGenes_MAST_GranuleCluster.txt")
