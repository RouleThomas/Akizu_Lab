...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED, na = FALSE) [,3] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED) [,3]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj3_humangastruloidUNTREATED2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj3_humangastruloidUNTREATED2472hrs, file = "output/condiments/traj3_humangastruloidUNTREATED2472hrs.rds")
