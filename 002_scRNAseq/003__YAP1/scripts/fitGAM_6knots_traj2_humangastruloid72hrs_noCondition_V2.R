...
pseudotimes <- slingPseudotime(humangastruloid72hrs, na = FALSE) [,2] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloid72hrs) [,2]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj2_noCondition_humangastruloid72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj2_noCondition_humangastruloid72hrs_V2, file = "output/condiments/traj2_noCondition_humangastruloid72hrs_V2.rds")
