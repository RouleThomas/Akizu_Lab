...
################### Time Course effect (DASATINIB CONDITION) - TRAJECTORY 5- ##############################################
set.seed(42)
traj5_humangastruloidDASATINIB2472hrs <- readRDS("output/condiments/traj5_humangastruloidDASATINIB2472hrs.rds")
...
traj5_humangastruloidDASATINIB2472hrs
#### Extract pseudotime values
pseudotime <- colData(traj5_humangastruloidDASATINIB2472hrs)$crv$pseudotime
#### Extract the expression matrix
expr_matrix <- assays(traj5_humangastruloidDASATINIB2472hrs)$counts
...
write.table(peak_df, file = c("output/condiments/traj5_humangastruloidDASATINIB2472hrs_ActivationPoint.txt"),sep="\t", quote=FALSE, row.names=FALSE)
