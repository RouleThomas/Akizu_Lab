...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED72hrs, na = FALSE) [,2] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED72hrs) [,2]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj2_humangastruloidUNTREATED72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj2_humangastruloidUNTREATED72hrs_V2, file = "output/condiments/traj2_humangastruloidUNTREATED72hrs_V2.rds")
