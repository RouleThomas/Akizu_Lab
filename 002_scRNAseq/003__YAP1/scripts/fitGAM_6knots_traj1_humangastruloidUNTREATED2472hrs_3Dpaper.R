...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED, na = FALSE) [,1] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED) [,1]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj1_humangastruloidUNTREATED2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj1_humangastruloidUNTREATED2472hrs, file = "output/condiments/traj1_humangastruloidUNTREATED2472hrs_3Dpaper.rds")
