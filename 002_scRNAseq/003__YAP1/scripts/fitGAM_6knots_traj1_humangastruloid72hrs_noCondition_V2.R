...
pseudotimes <- slingPseudotime(humangastruloid72hrs, na = FALSE) [,1] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloid72hrs) [,1]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj1_noCondition_humangastruloid72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj1_noCondition_humangastruloid72hrs_V2, file = "output/condiments/traj1_noCondition_humangastruloid72hrs_V2.rds")
