...
set.seed(42)
traj3_humangastruloidUNTREATED2472hrs <- readRDS("output/condiments/traj3_humangastruloidUNTREATED2472hrs.rds")
...
traj3_humangastruloidUNTREATED2472hrs
#### Extract pseudotime values
pseudotime <- colData(traj3_humangastruloidUNTREATED2472hrs)$crv$pseudotime
#### Extract the expression matrix
expr_matrix <- assays(traj3_humangastruloidUNTREATED2472hrs)$counts
...
write.table(peak_df, file = c("output/condiments/traj3_humangastruloidUNTREATED2472hrs_ActivationPoint.txt"),sep="\t", quote=FALSE, row.names=FALSE)
