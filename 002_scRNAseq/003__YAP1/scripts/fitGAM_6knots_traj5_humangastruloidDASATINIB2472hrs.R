...
pseudotimes <- slingPseudotime(humangastruloidDASATINIB, na = FALSE) [,5] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB) [,5]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj5_humangastruloidDASATINIB2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj5_humangastruloidDASATINIB2472hrs, file = "output/condiments/traj5_humangastruloidDASATINIB2472hrs.rds")
