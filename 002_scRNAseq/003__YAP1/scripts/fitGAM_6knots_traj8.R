...
#### Extract the pseudotimes and cell weights for the 8th lineage
pseudotimes <- slingPseudotime(embryo, na = FALSE) [,8]
cellweights <- slingCurveWeights(embryo) [,8]
...
saveRDS(traj8, file = "output/condiments/traj8.rds")
