...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED, na = FALSE) [,5] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED) [,5]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj5_humangastruloidUNTREATED2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj5_humangastruloidUNTREATED2472hrs, file = "output/condiments/traj5_humangastruloidUNTREATED2472hrs_3Dpaper.rds")
