...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED72hrs, na = FALSE) [,1] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED72hrs) [,1]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj1_humangastruloidUNTREATED72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj1_humangastruloidUNTREATED72hrs_V2, file = "output/condiments/traj1_humangastruloidUNTREATED72hrs_V2.rds")
