...
pseudotimes <- slingPseudotime(humangastruloid72hrs, na = FALSE) [,3] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloid72hrs) [,3]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj3_noCondition_humangastruloid72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj3_noCondition_humangastruloid72hrs_V2, file = "output/condiments/traj3_noCondition_humangastruloid72hrs_V2.rds")
