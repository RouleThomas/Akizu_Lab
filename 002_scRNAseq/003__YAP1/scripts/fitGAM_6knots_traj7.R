...
#### Extract the pseudotimes and cell weights for the 7th lineage
pseudotimes <- slingPseudotime(embryo, na = FALSE) [,7]
cellweights <- slingCurveWeights(embryo) [,7]
...
saveRDS(traj7, file = "output/condiments/traj7.rds")
