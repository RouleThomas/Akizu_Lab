...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED, na = FALSE) [,4] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED) [,4]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj4_humangastruloidUNTREATED2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj4_humangastruloidUNTREATED2472hrs, file = "output/condiments/traj4_humangastruloidUNTREATED2472hrs_3Dpaper.rds")
