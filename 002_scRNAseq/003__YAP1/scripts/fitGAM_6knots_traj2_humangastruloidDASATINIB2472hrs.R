...
pseudotimes <- slingPseudotime(humangastruloidDASATINIB, na = FALSE) [,2] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB) [,2]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj2_humangastruloidDASATINIB2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj2_humangastruloidDASATINIB2472hrs, file = "output/condiments/traj2_humangastruloidDASATINIB2472hrs.rds")
