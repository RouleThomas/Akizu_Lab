...
pseudotimes <- slingPseudotime(humangastruloidDASATINIB72hrs, na = FALSE) [,1] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB72hrs) [,1]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj1_humangastruloidDASATINIB72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj1_humangastruloidDASATINIB72hrs_V2, file = "output/condiments/traj1_humangastruloidDASATINIB72hrs_V2.rds")
