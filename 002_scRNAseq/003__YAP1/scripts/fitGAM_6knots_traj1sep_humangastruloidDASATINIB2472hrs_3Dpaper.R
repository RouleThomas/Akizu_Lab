...
pseudotimes <- slingPseudotime(humangastruloidDASATINIB, na = FALSE) [,1] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB) [,1]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj1sep_humangastruloidDASATINIB2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj1sep_humangastruloidDASATINIB2472hrs, file = "output/condiments/traj1sep_humangastruloidDASATINIB2472hrs_3Dpaper.rds")
