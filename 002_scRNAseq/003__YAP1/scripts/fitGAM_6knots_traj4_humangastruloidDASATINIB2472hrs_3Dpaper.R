...
#### Extract the pseudotimes and cell weights for the FOURTH lineage
pseudotimes <- slingPseudotime(humangastruloidDASATINIB, na = FALSE) [,4] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB) [,4]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj4_humangastruloidDASATINIB2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj4_humangastruloidDASATINIB2472hrs, file = "output/condiments/traj4_humangastruloidDASATINIB2472hrs_3Dpaper.rds")
