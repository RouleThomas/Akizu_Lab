...
pseudotimes <- slingPseudotime(humangastruloidDASATINIB72hrs, na = FALSE) [,3] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidDASATINIB72hrs) [,3]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj3_humangastruloidDASATINIB72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj3_humangastruloidDASATINIB72hrs_V2, file = "output/condiments/traj3_humangastruloidDASATINIB72hrs_V2.rds")
