...
#### Extract the pseudotimes and cell weights for the 4th lineage
pseudotimes <- slingPseudotime(embryo, na = FALSE) [,5]
cellweights <- slingCurveWeights(embryo) [,5]
...
saveRDS(traj5, file = "output/condiments/traj5.rds")
