...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED72hrs, na = FALSE) [,3] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED72hrs) [,3]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj3_humangastruloidUNTREATED72hrs_V2 <- fitGAM(
     counts = sub_counts, 
...
saveRDS(traj3_humangastruloidUNTREATED72hrs_V2, file = "output/condiments/traj3_humangastruloidUNTREATED72hrs_V2.rds")
