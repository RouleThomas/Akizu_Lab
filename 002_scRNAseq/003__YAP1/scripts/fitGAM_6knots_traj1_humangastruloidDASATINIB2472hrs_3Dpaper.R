...
traj1_humangastruloidDASATINIB2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj1_humangastruloidDASATINIB2472hrs, file = "output/condiments/traj1_humangastruloidDASATINIB2472hrs_3Dpaper.rds")
