...
load("output/condiments/condiments_humangastruloid2472hrs_V1.RData")
...
#### Extract the pseudotimes and cell weights for the FIFTH lineage
pseudotimes <- slingPseudotime(humangastruloid2472hrs, na = FALSE) [,5] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloid2472hrs) [,5]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj5_noCondition_humangastruloid2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj5_noCondition_humangastruloid2472hrs, file = "output/condiments/traj5_noCondition_humangastruloid2472hrs.rds")
