...
pseudotimes <- slingPseudotime(humangastruloid2472hrs, na = FALSE) [,3] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloid2472hrs) [,3]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj3_noCondition_humangastruloid2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj3_noCondition_humangastruloid2472hrs, file = "output/condiments/traj3_noCondition_humangastruloid2472hrs.rds")
