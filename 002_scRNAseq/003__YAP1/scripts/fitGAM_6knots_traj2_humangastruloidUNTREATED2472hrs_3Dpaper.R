...
pseudotimes <- slingPseudotime(humangastruloidUNTREATED, na = FALSE) [,2] # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
cellweights <- slingCurveWeights(humangastruloidUNTREATED) [,2]  # HERE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
traj2_humangastruloidUNTREATED2472hrs <- fitGAM(
     counts = sub_counts,
...
saveRDS(traj2_humangastruloidUNTREATED2472hrs, file = "output/condiments/traj2_humangastruloidUNTREATED2472hrs_3Dpaper.rds")
