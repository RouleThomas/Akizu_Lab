...
################### Time Course effect (DASATINIB CONDITION) - TRAJECTORY 2- ##############################################
set.seed(42)
traj2_humangastruloidDASATINIB2472hrs <- readRDS("output/condiments/traj2_humangastruloidDASATINIB2472hrs.rds")
...
traj2_humangastruloidDASATINIB2472hrs
#### Extract pseudotime values
pseudotime <- colData(traj2_humangastruloidDASATINIB2472hrs)$crv$pseudotime
#### Extract the expression matrix
expr_matrix <- assays(traj2_humangastruloidDASATINIB2472hrs)$counts
...
write.table(peak_df, file = c("output/condiments/traj2_humangastruloidDASATINIB2472hrs_ActivationPoint.txt"),sep="\t", quote=FALSE, row.names=FALSE)
