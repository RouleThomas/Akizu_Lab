...
#### Extract the pseudotimes and cell weights for the 6th lineage
pseudotimes <- slingPseudotime(embryo, na = FALSE) [,6]
cellweights <- slingCurveWeights(embryo) [,6]
...
saveRDS(traj6, file = "output/condiments/traj6.rds")
