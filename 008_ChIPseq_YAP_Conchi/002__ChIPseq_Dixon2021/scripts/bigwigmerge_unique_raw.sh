...
wiggletools write_bg output/bigwig/hESC_WT_H3K4me3_median.bedGraph \
...
wiggletools write_bg output/bigwig/hESC_WT_input_median.bedGraph \
    median output/bigwig/hESC_WT_input_R1.unique.dupmark.sorted.bw \
    output/bigwig/hESC_WT_input_R2.unique.dupmark.sorted.bw

wiggletools write_bg output/bigwig/hESC_WT_QSER1FLAG_median.bedGraph \
