...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_2kb_QSER1peaks_Ren_2.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Ren_2.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Ren_2_heatmap.pdf \
...
# interactive
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Ren_2.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Ren_2_heatmap1.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" "NIPBL" \
...
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Ren_2.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Ren_2_heatmap2.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" "NIPBL" \
    --colorList 'black, yellow' \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
...
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Ren_2.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Ren_2_heatmap3.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" "NIPBL" \
    --colorList 'black, yellow' \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
