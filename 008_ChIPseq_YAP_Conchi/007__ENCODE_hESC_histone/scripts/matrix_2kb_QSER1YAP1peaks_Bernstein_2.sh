...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_2kb_QSER1YAP1peaks_Bernstein_2.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_2kb_QSER1YAP1peaks_Bernstein_2.gz \
    -out output/deeptools/matrix_2kb_QSER1YAP1peaks_Bernstein_2_heatmap.pdf \
    --samplesLabel "YAP1" "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" "NIPBL" \
    --colorMap bwr \
...
# interactive
plotHeatmap -m output/deeptools/matrix_2kb_QSER1YAP1peaks_Bernstein_2.gz \
    -out output/deeptools/matrix_2kb_QSER1YAP1peaks_Bernstein_2_heatmap1.pdf \
    --samplesLabel "YAP1" "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" "NIPBL" \
