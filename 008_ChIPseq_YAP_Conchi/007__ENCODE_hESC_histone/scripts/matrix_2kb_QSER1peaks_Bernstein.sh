...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_2kb_QSER1peaks_Bernstein.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Bernstein.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Bernstein_heatmap.pdf \
...
# interactive
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Bernstein.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Bernstein_heatmap1.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" \
...
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Bernstein.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Bernstein_heatmap2.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" \
    --colorList 'black, yellow' \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
...
plotHeatmap -m output/deeptools/matrix_2kb_QSER1peaks_Bernstein.gz \
    -out output/deeptools/matrix_2kb_QSER1peaks_Bernstein_heatmap3.pdf \
    --samplesLabel "QSER1" "H3K4me1" "H3K27ac" "H3K36me3" "H3K27me3" "EZH2" \
    --colorList 'black, yellow' \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
