...
../001__ChIPseq_V1/output/bigwig_DiffBindTMM/hESC_WT_input_R1.unique.dupmark.sorted.bw -o output/bigwig_DiffBindTMM/multiBigwigSummary_008001008002_QSER1_DiffBindTMM.npz -p max
