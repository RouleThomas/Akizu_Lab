...
../002__ChIPseq_Dixon2021/output/bigwig/hESC_WT_EZH2_R1.unique.dupmark.sorted.bw \
...
../001__ChIPseq_V1/output/bigwig_DiffBindTMM/hESC_WT_input_R1.unique.dupmark.sorted.bw \
../001__ChIPseq_V1/output/bigwig_DiffBindTMM/hESC_WT_EZH2_R1.unique.dupmark.sorted.bw \
../001__ChIPseq_V1/output/bigwig_DiffBindTMM/hESC_WT_EZH2_R2.unique.dupmark.sorted.bw -o output/bigwig_DiffBindTMM/multiBigwigSummary_008001008002_QSER1EZH2_DiffBindTMM_bin2kb.npz -p max --blackListFileName /scr1/users/roulet/Akizu_Lab/Master/meta/hg38-blacklist.v2.bed --chromosomesToSkip chrX chrY chrM --binSize 2000
