...
def main():
    ...
    parser.add_argument("--outdir", default="results") # PATH UPDATED
    parser.add_argument("--sigfile", default="signatures/COSMIC_v3.4_SBS_GRCh38.txt") # PATH UPDATED
    parser.add_argument("--context", default="indices/context96.pkl") # PATH UPDATED
    parser.add_argument("--exome", default="parquet") # PATH UPDATED
    parser.add_argument("--dbnsfp", default="ref/dbNSFP5.2a_grch38.gz") # PATH UPDATED and dbNSFP5.2a used
