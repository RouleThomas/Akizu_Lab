...
RANDOM_FILE = INPUT_DIR / "Flat" / "Flat_summary_all_v3.tsv"
OUTPUT_PDF = "results/combined_signature_summary_plots-highlight_random_v3.pdf"
...
# Load SBS data
all_data = []
for file in sorted(INPUT_DIR.glob("SBS*/*_summary_all_v3.tsv")):
