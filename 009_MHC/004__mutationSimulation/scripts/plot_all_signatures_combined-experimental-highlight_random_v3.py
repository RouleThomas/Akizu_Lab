...
RANDOM_FILE = Path("results") / "Flat" / "Flat_summary_all_v3.tsv"
OUTPUT_PDF = "results_experimental/combined_signature_summary_plots-highlight_random_v3.pdf"
...
# Load data
all_data = []
for file in sorted(INPUT_DIR.glob("*/*_summary_all_v3.tsv")):
