...
def main():
    ...
    parser.add_argument("--sigfile", default="/scr1/users/roulet/Akizu_Lab/009_MHC/001__mutationSimulation/mutsim/signatures/human_sbs96_filtered_v1_0.txt") # MODIFIED
