...
ATACMultiomewithST_SMK_V2QCv2.sct <- FindClusters(ATACMultiomewithST_SMK_V2QCv2.sct, resolution = 0.2, verbose = FALSE, algorithm = 4) # method = "igraph" needed for large nb of cells


ATACMultiomewithST_SMK_V2QCv2.sct$condition <- factor(ATACMultiomewithST_SMK_V2QCv2.sct$condition, levels = c("Normoxia", "Hypoxia")) # 

pdf("output/seurat/DimPlot-ATACMultiomewithST_SMK_V2QCv2-dim30kparam30res02.pdf", width=7, height=6)
...
###########################################################################
# saveRDS(ATACMultiomewithST_SMK_V2QCv2.sct, file = "output/seurat/ATACMultiomewithST_SMK_V2QCv2-dim30kparam30res02.rds") 
ATACMultiomewithST_SMK_V2QCv2.sct <- readRDS(file = "output/seurat/ATACMultiomewithST_SMK_V2QCv2-dim30kparam30res02.rds")
###########################################################################
