...
## Shiny app V3;  including Ciceri RNAseq neuron diff dataset + Akoto 001/015 RNAseq
...
# prep the data
long_data_log2tpm = read.table("output/shinyApp/RNAseqDataViewer_V3/long_data_log2tpm.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Ciceri = read.table("output/shinyApp/RNAseqDataViewer_V3/long_data_log2tpm_Ciceri.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Akoto = read.table("output/shinyApp/RNAseqDataViewer_V3/long_data_log2tpm_Akoto.txt", sep = "\t", header = TRUE)
...
# Assuming the data is read from the respective files for Akizu, Ciceri, and Akoto
long_data_log2tpm_Akizu = read.table("long_data_log2tpm.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Ciceri = read.table("long_data_log2tpm_Ciceri.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Akoto = read.table("long_data_log2tpm_Akoto.txt", sep = "\t", header = TRUE)
'
writeLines(global, "output/shinyApp/RNAseqDataViewer_V3/global.R")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput("dataset", "Select Dataset:", choices = c("Akizu", "Ciceri", "Akoto")),
      selectizeInput("gene", "Select Gene:", choices = NULL, options = list("server" = TRUE)),
      checkboxGroupInput("tissue", "Select Tissue:", choices = NULL),
      checkboxGroupInput("genotype", "Select Genotype:", choices = NULL),
      numericInput("plot_width", label = "Plot Width", value = 500, min = 100, max = 2000, step = 10),
...
'
writeLines(ui_code, "output/shinyApp/RNAseqDataViewer_V3/ui.R")
...
writeLines(server_code, "output/shinyApp/RNAseqDataViewer_V3/server.R")

# Deploy the app
rsconnect::deployApp("output/shinyApp/RNAseqDataViewer_V3")
...
## Shiny app V5;  including Akoto 001/019



cp files to `long_data_log2tpm*.txt` files to `output/shinyApp/RNAseqDataViewer_V5`
- `output/tpm/long_data_log2tpm_Ciceri.txt` = Ciceri
- `output/shinyApp/*V3/long_data_log2tpm.txt`= our/Carolina: **`GOF` rename to `KOEF1aEZH1`/ `LOF` to `KO` manually**
- `output/shinyApp/*V3/long_data_log2tpm_Akoto.txt` = Jasmine from` 001*/015*`: **`PSC` rename to `ESC` manually**
- `output/shinyApp/*V4/long_data_log2tpm_Sanchez.txt` = Sanchez from` 005*/001*`: **`PSC` rename to `ESC` manually**
- `output/shinyApp/*V5/long_data_log2tpm_Akoto001019.txt` = Jasmine from` 001*/019*`: **`PSC` rename to `ESC` manually; `OE` rename to `KOEF1aEZH1`**
...
# prep the data
long_data_log2tpm = read.table("output/shinyApp/RNAseqDataViewer_V5/long_data_log2tpm.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Ciceri = read.table("output/shinyApp/RNAseqDataViewer_V5/long_data_log2tpm_Ciceri.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Akoto = read.table("output/shinyApp/RNAseqDataViewer_V5/long_data_log2tpm_Akoto.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Sanchez = read.table("output/shinyApp/RNAseqDataViewer_V5/long_data_log2tpm_Sanchez.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Akoto = read.table("output/shinyApp/RNAseqDataViewer_V5/long_data_log2tpm_Akoto001019.txt", sep = "\t", header = TRUE)
...
long_data_log2tpm_Akoto = read.table("long_data_log2tpm_Akoto.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Sanchez = read.table("long_data_log2tpm_Sanchez.txt", sep = "\t", header = TRUE)
long_data_log2tpm_Akoto001019 = read.table("long_data_log2tpm_Akoto001019.txt", sep = "\t", header = TRUE)
'
writeLines(global, "output/shinyApp/RNAseqDataViewer_V5/global.R")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      selectInput("dataset", "Select Dataset:", choices = c("Akizu", "Ciceri", "Akoto", "Sanchez", "Akoto001019")),
      selectizeInput("gene", "Select Gene:", choices = NULL, options = list("server" = TRUE)),
      checkboxGroupInput("tissue", "Select Tissue:", choices = NULL),
      checkboxGroupInput("genotype", "Select Genotype:", choices = NULL),
      numericInput("plot_width", label = "Plot Width", value = 500, min = 100, max = 2000, step = 10),
...
'
writeLines(ui_code, "output/shinyApp/RNAseqDataViewer_V5/ui.R")
...
server <- function(input, output, session) {
  ...
  observeEvent(input$dataset, {
    if (input$dataset == "Akizu") {
      ...
      tissues <- c("1monthCB", "1yearCB", "1monthCX", "1yearCX")
      genotypes <- c("WT", "KO")
    } else if (input$dataset == "Akoto001019") {
      genes <- unique(long_data_log2tpm_Akoto001019$external_gene_name)
      tissues <- c("ESC")
      genotypes <- c("WT", "KO", "KOEF1aEZH1")
    }
    updateSelectizeInput(session, "gene", choices = genes, server = TRUE)
  ...
  filtered_data <- reactive({
    if (input$dataset == "Akizu") {
      ...
      data <- long_data_log2tpm_Akoto001019
    }
...
writeLines(server_code, "output/shinyApp/RNAseqDataViewer_V5/server.R")

# Deploy the app
rsconnect::deployApp(
  appDir  = "output/shinyApp/RNAseqDataViewer_V5",
  appName = "RNAseqDataViewer_V5",
  server  = "shinyapps.io",
  forceUpdate = TRUE
) 
...
--> `001*/019*` data succesfully added.





In version 6, let's implement other functino such as:
