...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_2kb_bigwig_ChIPseqSpikeInFree_BamToBedToBigwig_uniqueSF_HETcluster1.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_gene_2kb_bigwig_ChIPseqSpikeInFree_BamToBedToBigwig_uniqueSF_HETcluster1.gz \
    -out output/deeptools/matrix_gene_2kb_bigwig_ChIPseqSpikeInFree_BamToBedToBigwig_uniqueSF_HETcluster1_heatmap.png \
    --colorMap bwr
