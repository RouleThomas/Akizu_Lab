...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_2kb_bigwig_THOR_ESCvsNPC_UniqueBamTMM_HETcluster5.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_gene_2kb_bigwig_THOR_ESCvsNPC_UniqueBamTMM_HETcluster5.gz \
    -out output/deeptools/matrix_gene_2kb_bigwig_THOR_ESCvsNPC_UniqueBamTMM_HETcluster5_heatmap.png \
    --colorMap bwr
