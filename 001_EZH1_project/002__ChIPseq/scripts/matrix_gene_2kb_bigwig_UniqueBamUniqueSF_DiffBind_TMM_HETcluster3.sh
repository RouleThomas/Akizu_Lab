...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_2kb_bigwig_UniqueBamUniqueSF_DiffBind_TMM_HETcluster3.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_gene_2kb_bigwig_UniqueBamUniqueSF_DiffBind_TMM_HETcluster3.gz \
    -out output/deeptools/matrix_gene_2kb_bigwig_UniqueBamUniqueSF_DiffBind_TMM_HETcluster3_heatmap.png \
    --colorMap bwr
