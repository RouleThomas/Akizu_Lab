...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster5.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster5.gz \
    -out output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster5_heatmap.png \
    --colorMap bwr \
