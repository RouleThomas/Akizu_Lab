...
sample_dba = dba(sampleSheet=read.table("output/DiffBind/meta_sample_NPC.txt", header = TRUE, sep = "\t"))
...
save(sample_count, file = "output/DiffBind/sample_count_NPC.RData")
