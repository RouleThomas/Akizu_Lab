...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster1.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster1.gz \
    -out output/deeptools/matrix_gene_2kb_bigwig_DiffBind_TMM_HETcluster1_heatmap.png \
    --colorMap bwr \
