...
percentile_file = "output/bigwig/Ferguson_SF.txt"
...
for sample_name in input_list:
    ...
    scaling_factor = percentile_value / reference_value  # Reciprocal of the previous logic

    input_file = os.path.join(local_maxima_dir, f"{sample_name}_local_maxima.bed")
    output_file = os.path.join(normalized_dir, f"{sample_name}_normv2.bedGraph")
