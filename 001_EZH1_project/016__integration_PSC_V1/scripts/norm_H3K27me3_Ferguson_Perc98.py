...
# Input file containing 98th percentile values
percentile_file = "output/bigwig/Ferguson_SF_98.txt"
...
# Load the 98th percentile values from the file
percentile_dict = {}
...
for sample_name in input_list:
    ...
    output_file = os.path.join(normalized_dir, f"{sample_name}_norm98.bedGraph")
