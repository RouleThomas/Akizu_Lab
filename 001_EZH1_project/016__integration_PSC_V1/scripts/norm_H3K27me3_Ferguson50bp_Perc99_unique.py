...
percentile_file = "output/bigwig_Ferguson50bp/Ferguson50bp_SF_99_unique.txt"
local_maxima_dir = "output/bigwig_Ferguson50bp"
normalized_dir = "output/bigwig_Ferguson50bp"
...
for sample_name in input_list:
    ...
    output_file = os.path.join(normalized_dir, f"{sample_name}_unique_norm99.bedGraph")
