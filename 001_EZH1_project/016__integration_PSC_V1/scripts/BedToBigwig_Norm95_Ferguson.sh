...
for sample in "${input_list[@]}"; do
    bedtools sort -i output/bigwig/${sample}_norm95.bedGraph > output/bigwig_Ferguson/${sample}_norm95.sorted.bedGraph

    bedGraphToBigWig \
        output/bigwig_Ferguson/${sample}_norm95.sorted.bedGraph \
        ../../Master/meta/GRCh38_chrom_sizes.tab \
        output/bigwig_Ferguson/${sample}_norm95.bw
done
