...
# Plot
## PCA
plotPCA -in output/deeptools/multiBigwigSummary_H3K27me3_THOR_TMM_bed.npz \
    --transpose \
    --ntop 0 \
    ...
    -o output/deeptools/multiBigwigSummary_H3K27me3_THOR_TMM_bed_plotPCA.pdf

## Heatmap
plotCorrelation \
    -in output/deeptools/multiBigwigSummary_H3K27me3_THOR_TMM_bed.npz \
    --corMethod pearson --skipZeros \
    --plotTitle "Pearson Correlation" \
    --removeOutliers \
    --labels WT_R1 WT_R2 WT_R3 KO_R1 KO_R2 KO_R3 KOEF1aEZH1_R1 KOEF1aEZH1_R2 KOEF1aEZH1_R3 \
    --whatToPlot heatmap --colorMap bwr --plotNumbers \
    -o output/deeptools/multiBigwigSummary_H3K27me3_THOR_TMM_bed_heatmap.pdf
