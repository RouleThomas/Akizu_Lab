...
def process_sample(sample_name):
    input_file = os.path.join(input_dir, f"{sample_name}_subtract.filter.blacklist.bedGraph")
    output_file = os.path.join(output_dir, f"{sample_name}_subtract_local_maxima.bed")
