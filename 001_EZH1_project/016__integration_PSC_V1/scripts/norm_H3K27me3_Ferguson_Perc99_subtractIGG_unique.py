...
percentile_file = "output/bigwig/Ferguson_SF_99_subtract_unique.txt"
local_maxima_dir = "output/bigwig"
normalized_dir = "output/bigwig_Ferguson"
os.makedirs(normalized_dir, exist_ok=True)

# Reference sample
reference_sample = "PSC_WT_H3K27me3_006R"
...
for sample_name in input_list:
    ...
    output_file = os.path.join(normalized_dir, f"{sample_name}_subtract_unique_norm99.bedGraph")
