...
input_dir = "output/bigwig_Ferguson50bp"
output_dir = "output/bigwig_Ferguson50bp"
os.makedirs(output_dir, exist_ok=True)  # Create output directory if it doesn't exist

# Function to process each sample
def process_sample(sample_name):
    input_file = os.path.join(input_dir, f"{sample_name}.50bp.unique.dupmark.sorted.blacklist.bedGraph")
