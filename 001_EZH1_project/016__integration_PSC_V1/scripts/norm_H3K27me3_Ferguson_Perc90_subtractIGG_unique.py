...
percentile_file = "output/bigwig/Ferguson_SF_90_subtract_unique.txt"
...
for sample_name in input_list:
    ...
    output_file = os.path.join(normalized_dir, f"{sample_name}_subtract_unique_norm90.bedGraph")
