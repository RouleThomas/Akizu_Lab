...
for x in "${input_list[@]}"; do
    bedtools intersect -v \
        -a output/bigwig_Ferguson50bp/${x}.50bp.unique.dupmark.sorted.bedGraph \
        -b ../../Master/meta/hg38-blacklist.v2.bed > output/bigwig_Ferguson50bp/${x}.50bp.unique.dupmark.sorted.blacklist.bedGraph
done
