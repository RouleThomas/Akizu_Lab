...
for sample in "${input_list[@]}"; do
    bedtools sort -i output/bigwig/${sample}_norm98.bedGraph > output/bigwig_Ferguson/${sample}_norm98.sorted.bedGraph

    bedGraphToBigWig \
        output/bigwig_Ferguson/${sample}_norm98.sorted.bedGraph \
        ../../Master/meta/GRCh38_chrom_sizes.tab \
        output/bigwig_Ferguson/${sample}_norm98.bw
done
