...
for sample in "${input_list[@]}"; do
    bedtools sort -i output/bigwig_Ferguson/${sample}_subtract_unique_norm95.bedGraph > output/bigwig_Ferguson/${sample}_subtract_unique_norm95.sorted.bedGraph

    bedGraphToBigWig \
        output/bigwig_Ferguson/${sample}_subtract_unique_norm95.sorted.bedGraph \
        ../../Master/meta/GRCh38_chrom_sizes.tab \
        output/bigwig_Ferguson/${sample}_subtract_unique_norm95.bw
done
