...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_1kb_THOR_WTpeaks.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_1kb_THOR_WTpeaks.gz \
    -out output/deeptools/matrix_TSS_1kb_THOR_WTpeaks_heatmap.png \
