...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kp_THORq15peaks.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kp_THORq15peaks.gz \
    -out output/deeptools/matrix_TSS_10kp_THORq15peaks_heatmap.png \
