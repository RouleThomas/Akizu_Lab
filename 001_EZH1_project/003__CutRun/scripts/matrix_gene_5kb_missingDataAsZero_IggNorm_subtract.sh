...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_gene_5kb_missingDataAsZero_IggNorm_subtract.gz \
    -p max/2 \
    --outFileSortedRegions output/deeptools/matrix_gene_5kb_missingDataAsZero_IggNorm_subtract.bed
