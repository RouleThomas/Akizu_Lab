...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kb_missingDataAsZero_IggNorm_log2ratio.gz \
    -p 6 \
    --outFileSortedRegions output/deeptools/matrix_TSS_10kb_missingDataAsZero_IggNorm_log2ratio.bed
