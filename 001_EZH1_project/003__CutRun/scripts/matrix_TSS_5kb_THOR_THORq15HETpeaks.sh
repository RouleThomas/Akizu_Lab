...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_5kp_THORq15HETpeaks.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_5kp_THORq15HETpeaks.gz \
    -out output/deeptools/matrix_TSS_5kp_THORq15HETpeaks_heatmap.png \
