...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kp_THORq15Gene.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kp_THORq15Gene.gz \
    -out output/deeptools/matrix_TSS_10kp_THORq15Gene_heatmap.png \
