...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_5kb_THOR_WT_8wN_quintile.gz \
    -p 8 \
    --outFileSortedRegions output/deeptools/matrix_TSS_5kb_THOR_WT_8wN_quintile.bed


plotProfile -m output/deeptools/matrix_TSS_5kb_THOR_WT_8wN_quintile.gz \
    -out output/deeptools/matrix_TSS_5kb_THOR_WT_8wN_quintile_profile.pdf
