...
computeMatrix scale-regions \
    ...
    -o output/deeptools/matrix_TSS_2kb_THOR_allGenes.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_2kb_THOR_allGenes.gz \
    -out output/deeptools/matrix_TSS_2kb_THOR_allGenes_heatmap.png \
