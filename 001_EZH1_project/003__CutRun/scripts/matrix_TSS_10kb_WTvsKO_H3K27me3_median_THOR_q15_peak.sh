...
plotHeatmap -m output/deeptools/matrix_TSS_10kb_WTvsKO_H3K27me3_median_THOR_q15_peak.gz \
    -out output/deeptools/matrix_TSS_10kb_WTvsKO_H3K27me3_median_THOR_q15_peak_heatmap4.pdf \
    --samplesLabel "WT" "KO" \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
    --heatmapWidth 2 \
...
plotProfile -m output/deeptools/matrix_TSS_10kb_WTvsKO_H3K27me3_median_THOR_q15_peak.gz \
    -out output/deeptools/matrix_TSS_10kb_WTvsKO_H3K27me3_median_THOR_q15_peak_profile.pdf \
    --samplesLabel "WT" "KO" \
    --perGroup \
    --colors black red \
    --refPointLabel "TSS" \
