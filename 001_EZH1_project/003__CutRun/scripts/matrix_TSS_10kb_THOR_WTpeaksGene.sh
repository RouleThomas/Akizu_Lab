...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_10kb_THOR_WTpeaksGene.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kb_THOR_WTpeaksGene.gz \
    -out output/deeptools/matrix_TSS_10kb_THOR_WTpeaksGene_heatmap.png \
