...
samples=(8wN_HET_IGG_R1 8wN_HET_H3K27me3_R1 8wN_HET_IGG_R2 8wN_HET_H3K27me3_R2 8wN_KO_IGG_R1 8wN_KO_H3K27me3_R1 8wN_KO_IGG_R2 8wN_KO_H3K27me3_R2 8wN_iPSCpatient_IGG_R1 8wN_iPSCpatient_H3K27me3_R1 8wN_WT_IGG_R1 8wN_WT_H3K27me3_R1 8wN_WT_IGG_R2 8wN_WT_H3K27me3_R2 8wN_HET_IGG_R3 8wN_HET_H3K27me3_R3 8wN_HET_IGG_R4 8wN_HET_H3K27me3_R4 8wN_KO_IGG_R3 8wN_KO_H3K27me3_R3 8wN_KO_IGG_R4 8wN_KO_H3K27me3_R4 8wN_iPSCpatient_IGG_R2 8wN_iPSCpatient_H3K27me3_R2 8wN_WT_IGG_R3 8wN_WT_H3K27me3_R3 8wN_WT_IGG_R4 8wN_WT_H3K27me3_R4)
...
for sample in "${samples[@]}"; do
    ...
    echo "_1.fq.gz 250bp 22nt barcodes = 8 counts"
    for barcode in "${barcodes[@]}"; do
        zgrep -c $barcode input/${sample}_1.fq.gz
    done
done

for sample in "${samples[@]}"; do
    echo "Analyzing sample $sample:"
    echo "_2.fq.gz 250bp 22nt barcodes = 8 counts"
    for barcode in "${barcodes[@]}"; do
        zgrep -c $barcode input/${sample}_2.fq.gz
    done
done
