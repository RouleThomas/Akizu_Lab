...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS2_500bp_THOR_allGenes.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS2_500bp_THOR_allGenes.gz \
    -out output/deeptools/matrix_TSS2_500bp_THOR_allGenes_heatmap.png \
