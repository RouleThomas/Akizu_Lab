...
percentile_file = "output/bigwig/Ferguson_SF_99_unique_AUTOSOMALCHR.txt"
local_maxima_dir = "output/bigwig"
normalized_dir = "output/bigwig_Ferguson"
os.makedirs(normalized_dir, exist_ok=True)

# Reference sample
reference_sample = "ESC_WT_H3K27me3_R1"
...
for sample_name in input_list:
    ...
    output_file = os.path.join(normalized_dir, f"{sample_name}_unique_norm99_initialBigwig_AUTOSOMALCHR.bedGraph")
