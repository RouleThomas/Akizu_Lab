...
for x in "${input_list[@]}"; do
    bedtools intersect -v \
        -a output/bigwig/${x}_noXchr.unique.dupmark.sorted.bedGraph \
        -b ../../Master/meta/hg38-blacklist.v2.bed > output/bigwig/${x}_noXchr.unique.dupmark.sorted.blacklist.bedGraph
done
