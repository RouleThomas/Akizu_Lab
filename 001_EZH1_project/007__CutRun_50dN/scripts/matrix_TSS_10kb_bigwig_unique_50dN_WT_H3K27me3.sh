...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_10kb_bigwig_unique_50dN_WT_H3K27me3.gz \
    -p 6




plotHeatmap -m output/deeptools/matrix_TSS_10kb_bigwig_unique_50dN_WT_H3K27me3.gz \
    -out output/deeptools/matrix_TSS_10kb_bigwig_unique_50dN_WT_H3K27me3_heatmap2.pdf \
