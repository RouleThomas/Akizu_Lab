...
output/bigwig/50dNFA_KOEF1aEZH1_H3K27me3.unique.dupmark.sorted.bw \
output/bigwig/NPC_KO_EZH1cs.unique.dupmark.sorted.bw \
...
output/bigwig/NPC_WT_SUZ12.unique.dupmark.sorted.bw -o output/bigwig/multiBigwigSummary_all.npz -p max
