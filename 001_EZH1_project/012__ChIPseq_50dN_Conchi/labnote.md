...
```bash
sbatch scripts/fastp_1.sh # 21503292 ok
```
...
**raw**
```bash
sbatch scripts/fastqc_1_raw.sh # 21503336 ok
```
...
sbatch --dependency=afterany:21503292 scripts/bowtie2_1.sh # 21503356 ok
```
...
sbatch --dependency=afterany:21503356 scripts/samtools_unique_1.sh # 21503369 ok
```
...
sbatch scripts/bamtobigwig_unique_extendReads100_1.sh # 21517207 xxx
