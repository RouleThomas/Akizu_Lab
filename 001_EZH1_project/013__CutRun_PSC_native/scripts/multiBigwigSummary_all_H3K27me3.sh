...
multiBigwigSummary bins -b output/bigwig/PSC_KO_H3K27me3_R1.unique.dupmark.sorted.bw \
    ...
    output/bigwig/PSC_WTEF1aEZH1_H3K27me3_R2.unique.dupmark.sorted.bw -o output/bigwig/multiBigwigSummary_all_H3K27me3.npz
