...
multiBigwigSummary bins -b output/bigwig/PSC_KO_EZH1_R1.unique.dupmark.sorted.bw \
    ...
    output/bigwig/PSC_WTEF1aEZH1_SUZ12_R2.unique.dupmark.sorted.bw -o output/bigwig/multiBigwigSummary_PSC.npz
