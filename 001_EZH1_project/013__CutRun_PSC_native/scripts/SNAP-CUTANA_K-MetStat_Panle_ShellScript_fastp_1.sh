...
samples=(NEU_WT_H3K27me3_R1 NEU_WT_IGG_R1 PSC_WT_H3K27me3_R1 PSC_WT_IGG_R1 PSC_KO_H3K27me3_R1 PSC_KO_IGG_R1 PSC_KOEF1aEZH1_H3K27me3_R1 PSC_KOEF1aEZH1_IGG_R1 PSC_WTEF1aEZH1_H3K27me3_R1 PSC_WTEF1aEZH1_IGG_R1)
...
for sample in "${samples[@]}"; do
    ...
    for barcode in "${barcodes[@]}"; do
        zgrep -c $barcode output/fastp/${sample}_1.fq.gz
    done
done
...
for sample in "${samples[@]}"; do
    ...
    for barcode in "${barcodes[@]}"; do
        zgrep -c $barcode output/fastp/${sample}_2.fq.gz
    done
done
