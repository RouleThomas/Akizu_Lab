...
multiBigwigSummary bins -b output/bigwig/PSC_KOEF1aEZH1_H3K27me3_R1.unique.dupmark.sorted.bw \
    ...
    output/bigwig/PSC_WTEF1aEZH1_IGG_R2.unique.dupmark.sorted.bw -o output/bigwig/multiBigwigSummary_WTEF1aEZH1vsKOEF1aEZH1_H3K27me3.npz
