...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kb_H3K27me3_median_THOR_allGenes.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THOR_allGenes.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THOR_allGenes_heatmap_colorSmall.pdf \
    --samplesLabel "WT" "KO" \
    --colorMap bwr \
...
plotProfile -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THOR_allGenes.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THOR_allGenes_profile.pdf \
    --samplesLabel "WT" "KO" \
    --perGroup \
    --colors black red \
    --refPointLabel "TSS" \
