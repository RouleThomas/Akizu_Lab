...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-allGenes.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-allGenes.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-allGenes_heatmap.pdf \
