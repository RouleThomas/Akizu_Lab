...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_5kb-THORq30-gene.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_5kb-THORq30-gene.gz \
    -out output/deeptools/matrix_TSS_5kb-THORq30-gene_heatmap.pdf \
...
plotHeatmap -m output/deeptools/matrix_TSS_5kb-THORq30-gene.gz \
    -out output/deeptools/matrix_TSS_5kb-THORq30-gene_heatmap1.pdf \
    --samplesLabel "WT_LocalMaxima" "KO_LocalMaxima" \
    --colorMap bwr \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 8 \
