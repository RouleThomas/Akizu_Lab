...
computeMatrix reference-point --referencePoint TSS \
    ...
    -o output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks.gz \
    -p 6
...
plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks_heatmap_colorSmall2.pdf \
    --samplesLabel "WT" "KO" \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
    --heatmapWidth 2 \
...
plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks_heatmap_colorSmall3.pdf \
    --samplesLabel "WT" "KO" \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
    --heatmapWidth 2 \
...
plotProfile -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks_profile.pdf \
    --samplesLabel "WT" "KO" \
    --perGroup \
    --colors black red \
    --refPointLabel "TSS" \
...
plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3_median_THORLIBspikein_genePeaks_heatmap_colorSmall4.pdf \
    --samplesLabel "WT" "KO" \
    --whatToShow 'heatmap and colorbar' \
    --heatmapHeight 10 \
    --heatmapWidth 2 \
