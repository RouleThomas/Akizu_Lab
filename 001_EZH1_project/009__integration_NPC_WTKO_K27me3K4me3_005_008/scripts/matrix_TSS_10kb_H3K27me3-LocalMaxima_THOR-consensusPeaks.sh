...
computeMatrix reference-point --referencePoint center \
    ...
    -o output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-consensusPeaks.gz \
    -p 6



plotHeatmap -m output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-consensusPeaks.gz \
    -out output/deeptools/matrix_TSS_10kb_H3K27me3-LocalMaxima_THOR-consensusPeaks_heatmap.pdf \
